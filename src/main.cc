...
int main(){
    ...
    if (c_baseline_active) {
        ...
        cp_c_time = cp_c_query_watch.GetElapsedTime();
    ...
    if (ffht_active) {
        ...
        cout << "Finished FFHT queries in " << ffht_c_time << " cycles" << endl;
        cout << "Finished FFHT queries in " << (float) ffht_c_time / (float) num_queries << " cycles/query" << endl;
        cout << "Flops per Query: " << endl;
